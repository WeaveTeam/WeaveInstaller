...
//		Settings.OS = OS_TYPE.WINDOWS;
//		File f = new File("C:/Users/Pat/AppData/Roaming/.weave/bin/Updater.jar");
//		try {
//			boolean t = FileUtils.isOnRemoveableMedia(f);
//			System.out.println("Is: " + (t ? "TRUE" : "FALSE"));
//		} catch (IOException e) {
//			e.printStackTrace();
//		} catch (InterruptedException e) {
//			e.printStackTrace();
